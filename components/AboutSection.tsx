...
export default function AboutSection() {
  return (
    <section 
      className="w-full pt-6 pb-20 sm:pt-24 sm:pb-24 lg:pt-32 lg:pb-32"
      ...
      <Container>
        <div className="grid grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div 
              className="relative w-full max-w-[280px] sm:max-w-md aspect-square rounded-full overflow-hidden"
              style={{ 
