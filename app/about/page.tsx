      ...
      >
        <Container>
          <div className="grid grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
            {/* Left: Text Content */}
            <div className="flex flex-col gap-6 sm:gap-8 lg:gap-12 order-2 lg:order-1 min-w-0">
              {/* Quoted Paragraph */}
              <blockquote 
            ...
            {/* Right: Circular Image — aspect-ratio prevents layout shift */}
            <div className="flex justify-center lg:justify-end order-1 lg:order-2 min-w-0">
              <div 
              ...
              >
                <Image
                  src="/assets/rosen/Rosen Relations Picture.jpg"
